  ...
  update() {
    ...
    for (const line of this.lines.items) {
      ...
      line.stone.position.y +=
        (line.elevationTarget - line.stone.position.y) * this.game.ticker.deltaScaled * 3;
      ...
      line.stone.position.z +=
        (line.offsetTarget - line.stone.position.z) * this.game.ticker.deltaScaled * 10;
    }
    ...
    this.year.group.position.z +=
      (finalPositionZ - this.year.group.position.z) * this.game.ticker.deltaScaled * 10;
