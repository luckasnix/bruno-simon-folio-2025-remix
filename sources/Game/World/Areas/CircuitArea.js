...
export class CircuitArea extends Area {
  ...
  setMenu() {
    ...
    this.menu.leaderboardContainerElement = this.menu.instance.contentElement.querySelector(
      ".js-leaderboard-container",
    );
    this.menu.leaderboardElement =
      this.menu.leaderboardContainerElement.querySelector(".js-leaderboard tbody");
  ...
  update() {
    if (this.state === CircuitArea.STATE_RUNNING) {
      ...
      for (const obstacle of this.obstacles.items) {
        ...
        const osciliation =
          Math.sin(this.timer.elapsedTime * 1.25 + obstacle.osciliationOffset) * 5;
