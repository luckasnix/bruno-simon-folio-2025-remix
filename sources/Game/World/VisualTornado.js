...
export class VisualTornado {
  ...
  setMesh() {
    ...
    material.outputNode = Fn(() => {
      ...
      const emissiveNoise1 = texture(this.game.noises.perlin, emissiveNoise1Uv, 1).r.remap(
        0.45,
        0.7,
      );
      ...
      const emissiveNoise2 = texture(this.game.noises.perlin, emissiveNoise2Uv, 1).r.remap(
        0.45,
        0.7,
      );
