...
export class Whispers {
  ...
  setFlames() {
    ...
    beamMaterial.outputNode = Fn(() => {
      ...
      const mask = texture(this.game.resources.whisperFlameTexture, baseUv).r.sub(
        revealAttribute.oneMinus(),
      );
  ...
  setMenu() {
    ...
    this.menu.previewMessage =
      this.menu.instance.previewElement.querySelector(".js-preview-message");
    ...
    this.menu.previewMessageText.addEventListener("input", () => {
