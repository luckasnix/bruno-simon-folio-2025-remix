  ...
  async init() {
    ...
    this.resources = await this.resourcesLoader.load([
      [
        ...
        `respawns/respawnsReferences${compressedModelSuffix}.glb${cb}`,
        "gltf",
      ],
      [
        "behindTheSceneStarsTexture",
        `behindTheScene/stars.${compressedTextureExtension}${cb}`,
      ...
      [
        "soundTexture",
        `intro/sound.${compressedTextureExtension}${cb}`,
        compressedTextureFormat,
        (resource) => {
      ...
      [
        "paletteTexture",
        `palette.${compressedTextureExtension}${cb}`,
        compressedTextureFormat,
        (resource) => {
          resource.minFilter = THREE.NearestFilter;
          resource.magFilter = THREE.NearestFilter;
    ...
    const resourcesPromise = this.resourcesLoader.load(
      [
        [
          "foliageTexture",
          `foliage/foliageSDF.${compressedTextureExtension}${cb}`,
          compressedTextureFormat,
          (resource) => {
            resource.minFilter = THREE.NearestFilter;
            resource.magFilter = THREE.NearestFilter;
        ...
        [
          "playgroundVisual",
          `playground/playgroundVisual${compressedModelSuffix}.glb${cb}`,
          "gltf",
        ],
        [
          "playgroundPhysical",
          `playground/playgroundPhysical${compressedModelSuffix}.glb${cb}`,
          "gltf",
        ],
        [
          "flowersReferencesModel",
          `flowers/flowersReferences${compressedModelSuffix}.glb${cb}`,
          "gltf",
        ],
        ...
        [
          ...
          `explosiveCrates/explosiveCrates${compressedModelSuffix}.glb${cb}`,
          "gltf",
        ],
        ["lanternsModel", `lanterns/lanterns${compressedModelSuffix}.glb${cb}`, "gltf"],
        [
          "terrainTexture",
          `terrain/terrain.${compressedTextureExtension}${cb}`,
          compressedTextureFormat,
          (resource) => {
        ...
        [
          ...
          `birchTrees/birchTreesVisual${compressedModelSuffix}.glb${cb}`,
          "gltf",
        ],
        [
          "birchTreesReferencesModel",
          `birchTrees/birchTreesReferences${compressedModelSuffix}.glb${cb}`,
          "gltf",
        ],
        ["oakTreesVisualModel", `oakTrees/oakTreesVisual${compressedModelSuffix}.glb${cb}`, "gltf"],
        [
          "oakTreesReferencesModel",
          `oakTrees/oakTreesReferences${compressedModelSuffix}.glb${cb}`,
          "gltf",
        ],
        [
          "cherryTreesVisualModel",
          `cherryTrees/cherryTreesVisual${compressedModelSuffix}.glb${cb}`,
          "gltf",
        ],
        [
          "cherryTreesReferencesModel",
          `cherryTrees/cherryTreesReferences${compressedModelSuffix}.glb${cb}`,
          "gltf",
        ],
        ...
        [
          "whisperFlameTexture",
          `whispers/whisperFlame.${compressedTextureExtension}${cb}`,
          compressedTextureFormat,
          (resource) => {
            resource.minFilter = THREE.LinearFilter;
            resource.magFilter = THREE.LinearFilter;
        ...
        [
          "satanStarTexture",
          `areas/satanStar.${compressedTextureExtension}${cb}`,
          compressedTextureFormat,
          (resource) => {
            resource.minFilter = THREE.LinearFilter;
            resource.magFilter = THREE.LinearFilter;
        ...
        [
          ...
          `tornado/tornadoPathReferences${compressedModelSuffix}.glb${cb}`,
          "gltf",
        ],
        [
          "overlayPatternTexture",
          `overlay/overlayPattern.${compressedTextureExtension}${cb}`,
          compressedTextureFormat,
          (resource) => {
            resource.wrapS = THREE.RepeatWrapping;
            resource.wrapT = THREE.RepeatWrapping;
        ...
        [
          ...
          `interactivePoints/interactivePointsKeyIconCross.${compressedTextureExtension}${cb}`,
          compressedTextureFormat,
          (resource) => {
            resource.minFilter = THREE.NearestFilter;
            resource.magFilter = THREE.NearestFilter;
        ...
        [
          ...
          `interactivePoints/interactivePointsKeyIconEnter.${compressedTextureExtension}${cb}`,
          compressedTextureFormat,
          (resource) => {
            resource.minFilter = THREE.NearestFilter;
            resource.magFilter = THREE.NearestFilter;
        ...
        [
          ...
          `interactivePoints/interactivePointsKeyIconA.${compressedTextureExtension}${cb}`,
          compressedTextureFormat,
          (resource) => {
            resource.minFilter = THREE.NearestFilter;
            resource.magFilter = THREE.NearestFilter;
        ...
        [
          "jukeboxMusicNotes",
          `jukebox/jukeboxMusicNotes.${compressedTextureExtension}${cb}`,
          compressedTextureFormat,
          (resource) => {
            resource.minFilter = THREE.LinearFilter;
            resource.magFilter = THREE.LinearFilter;
        ...
        [
          ...
          `achievements/glyphs.${compressedTextureExtension}${cb}`,
          compressedTextureFormat,
          (resource) => {
            resource.minFilter = THREE.LinearFilter;
            resource.magFilter = THREE.LinearFilter;
        ...
        [
          ...
          `career/careerFreelancer.${compressedTextureExtension}${cb}`,
          compressedTextureFormat,
          (resource) => {
            resource.flipY = false;
            resource.minFilter = THREE.LinearFilter;
        ...
        [
          "careerHeticTexture",
          `career/careerHetic.${compressedTextureExtension}${cb}`,
          compressedTextureFormat,
          (resource) => {
            resource.flipY = false;
            resource.minFilter = THREE.LinearFilter;
        ...
        [
          ...
          `career/careerImmersiveGarden.${compressedTextureExtension}${cb}`,
          compressedTextureFormat,
          (resource) => {
            resource.flipY = false;
            resource.minFilter = THREE.LinearFilter;
        ...
        [
          ...
          `career/careerIRLTeacher.${compressedTextureExtension}${cb}`,
          compressedTextureFormat,
          (resource) => {
            resource.flipY = false;
            resource.minFilter = THREE.LinearFilter;
        ...
        [
          ...
          `career/careerOnlineTeacher.${compressedTextureExtension}${cb}`,
          compressedTextureFormat,
          (resource) => {
            resource.flipY = false;
            resource.minFilter = THREE.LinearFilter;
        ...
        [
          "careerUzikTexture",
          `career/careerUzik.${compressedTextureExtension}${cb}`,
          compressedTextureFormat,
          (resource) => {
            resource.flipY = false;
            resource.minFilter = THREE.LinearFilter;
        ...
        [
          ...
          `timeMachine/timeMachineScreenMGS.${compressedTextureExtension}${cb}`,
          compressedTextureFormat,
          (resource) => {
            resource.minFilter = THREE.NearestFilter;
            resource.magFilter = THREE.NearestFilter;
        ...
        [
          ...
          `timeMachine/timeMachineScreenFolio.${compressedTextureExtension}${cb}`,
          compressedTextureFormat,
          (resource) => {
            resource.minFilter = THREE.NearestFilter;
            resource.magFilter = THREE.NearestFilter;
